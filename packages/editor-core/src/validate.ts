...
export function validateCommand(seq: Sequence, cmd: unknown): ValidationResult {
  ...
  const needClip = ['DELETE_CLIP', 'MOVE_CLIP', 'TRIM_CLIP', 'SPLIT_CLIP', 'DUPLICATE_CLIP', 'CHANGE_SPEED', 'CHANGE_VOLUME', 'SET_FADE', 'CHANGE_TRANSFORM', 'SET_FILTERS', 'SET_CROP', 'SET_TEXT', 'SET_CAPTION_STYLE', 'ADD_TRANSITION', 'SET_KEYFRAMES'];
